...
export const MainMenu: React.FC<MainMenuProps> = ({
  ...
  return (
    <div className="absolute inset-0 bg-black/70 flex flex-col items-center justify-center text-white backdrop-blur-sm z-20 overflow-y-auto py-4 md:py-8">
      <h1 className="text-2xl md:text-5xl text-transparent bg-clip-text bg-gradient-to-b from-yellow-400 to-yellow-600 mb-4 md:mb-6 font-['Press_Start_2P'] tracking-tighter text-center drop-shadow-[4px_4px_0_rgba(0,0,0,1)] stroke-black" style={{ WebkitTextStroke: '1px black' }}>
        SUPER KART<br/>BROS
      </h1>
          ...
          <div className="flex-1 space-y-2 md:space-y-4">
              <div className="bg-gray-800/90 p-3 md:p-5 rounded-lg border-2 border-white/20 shadow-xl">
                  <div className="flex items-center gap-2 mb-2 md:mb-3">
                      ...
                      <h2 className="font-bold text-blue-200">Select Track</h2>
                  </div>
              ...
              <div className="bg-gray-800/90 p-3 md:p-5 rounded-lg border-2 border-white/20 shadow-xl">
                   <div className="flex items-center gap-2 mb-2 md:mb-3">
                      ...
                      <h2 className="font-bold text-pink-200">Kart Color</h2>
                  </div>
          ...
          <div className="flex-1 space-y-2 md:space-y-4 flex flex-col">
               <div className="bg-gradient-to-r from-purple-900/80 to-indigo-900/80 p-3 md:p-5 rounded-lg border-2 border-purple-500/30 shadow-lg">
                  ...
                  <div className="flex gap-2">
                      ...
                      >
                      {isLoading ? <Loader2 className="animate-spin" size={14} /> : "GEN"}
                      </button>
                  </div>
              </div>
              ...
              >
                  <Play size={24} className="md:w-8 md:h-8" fill="currentColor" /> RACE!
              </button>
          </div>
      </div>
    </div>

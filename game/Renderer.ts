...
export class GameRenderer {
    ...
    private drawBoss(boss: Boss) {
        ...
        // Ears (Draw first so they are behind head)
        ...
        // Left Ear
        ctx.beginPath();
        ctx.moveTo(x + 40, drawY + 40);
        ctx.lineTo(x - 10, drawY - 20); // Tip
        ctx.lineTo(x + 90, drawY + 20);
        ctx.fill();
        ctx.stroke();

        // Right Ear
        ctx.beginPath();
        ctx.moveTo(x + w - 40, drawY + 40);
        ctx.lineTo(x + w + 10, drawY - 20); // Tip
        ctx.lineTo(x + w - 90, drawY + 20);
        ctx.fill();
        ctx.stroke();
        ...
        ctx.beginPath();
        ctx.ellipse(x + w / 2, drawY + h / 2, w / 2, h / 2 - 10, 0, 0, Math.PI * 2);
        ctx.fill();
        ctx.stroke();

        // Stripes (Tabby markings)
        ctx.fillStyle = '#CC8400';
        ctx.beginPath();
        ctx.moveTo(x + w / 2 - 20, drawY + 20);
        ctx.lineTo(x + w / 2 + 20, drawY + 20);
        ctx.lineTo(x + w / 2, drawY + 50);
        ctx.fill();

        // Eyes
        ctx.fillStyle = 'white';
        ctx.beginPath();
        ctx.ellipse(x + w / 2 - 40, drawY + h / 2 - 10, 25, 30, 0, 0, Math.PI * 2);
        ctx.fill();
        ctx.beginPath();
        ctx.ellipse(x + w / 2 + 40, drawY + h / 2 - 10, 25, 30, 0, 0, Math.PI * 2);
        ctx.fill();

        // Pupils (Cat like vertical slits)
        ctx.fillStyle = '#00FF00'; // Green eyes
        ctx.beginPath();
        ctx.ellipse(x + w / 2 - 40, drawY + h / 2 - 10, 8, 20, 0, 0, Math.PI * 2);
        ctx.fill();
        ctx.beginPath();
        ctx.ellipse(x + w / 2 + 40, drawY + h / 2 - 10, 8, 20, 0, 0, Math.PI * 2);
        ctx.fill();
        ...
        ctx.fillStyle = 'pink';
        ctx.beginPath();
        ctx.moveTo(x + w / 2 - 12, drawY + h / 2 + 25);
        ctx.lineTo(x + w / 2 + 12, drawY + h / 2 + 25);
        ctx.lineTo(x + w / 2, drawY + h / 2 + 40);
        ctx.fill();
        ...
        ctx.beginPath();
        ctx.moveTo(x + w / 2, drawY + h / 2 + 40);
        ctx.quadraticCurveTo(x + w / 2 - 20, drawY + h / 2 + 60, x + w / 2 - 40, drawY + h / 2 + 45);
        ctx.stroke();
        ctx.beginPath();
        ctx.moveTo(x + w / 2, drawY + h / 2 + 40);
        ctx.quadraticCurveTo(x + w / 2 + 20, drawY + h / 2 + 60, x + w / 2 + 40, drawY + h / 2 + 45);
        ...
        ctx.lineWidth = 2;
        // Left
        ctx.beginPath(); ctx.moveTo(x + w / 2 - 60, drawY + h / 2 + 35); ctx.lineTo(x - 30, drawY + h / 2 + 15); ctx.stroke();
        ctx.beginPath(); ctx.moveTo(x + w / 2 - 60, drawY + h / 2 + 45); ctx.lineTo(x - 30, drawY + h / 2 + 45); ctx.stroke();
        ctx.beginPath(); ctx.moveTo(x + w / 2 - 60, drawY + h / 2 + 55); ctx.lineTo(x - 30, drawY + h / 2 + 75); ctx.stroke();
        // Right
        ctx.beginPath(); ctx.moveTo(x + w / 2 + 60, drawY + h / 2 + 35); ctx.lineTo(x + w + 30, drawY + h / 2 + 15); ctx.stroke();
        ctx.beginPath(); ctx.moveTo(x + w / 2 + 60, drawY + h / 2 + 45); ctx.lineTo(x + w + 30, drawY + h / 2 + 45); ctx.stroke();
        ctx.beginPath(); ctx.moveTo(x + w / 2 + 60, drawY + h / 2 + 55); ctx.lineTo(x + w + 30, drawY + h / 2 + 75); ctx.stroke();

        // Health Bar
        ctx.fillStyle = '#000';
        ctx.fillRect(x + 20, drawY - 50, 140, 10);
        ctx.fillStyle = '#ff0000';
        ctx.fillRect(x + 22, drawY - 48, 136 * (boss.hp / boss.maxHp), 6);
    }
